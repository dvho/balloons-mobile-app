...
class Balloon extends React.PureComponent {
    ...
    render() {
        ...
        }).start(() => this.props.decreaseLife(this.state.touched, specialBalloon)) //call the equivalent of animationEnd by having an anonymous function call decreaseLife with the argument as to whether or not it was touched or escaped
