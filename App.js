...
const allImages = [require('./src/assets/images/balloon-radial-gradient.png'), require('./src/assets/images/beach.png'), require('./src/assets/images/icon-large.png'), require('./src/assets/images/logo.png'), require('./src/assets/images/skull1.png'), require('./src/assets/images/skull2.png')]
